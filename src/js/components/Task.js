 ...
 class Task extends BaseFormComponent{
    ...
    handleMoveDown(){
        this.props.moveDownHandler(this.props.id);
    }
    handleMoveUp(){
        this.props.moveUpHandler(this.props.id);
    }
     ...
     render(){
         ...
         if(listTasks.length > 1){
             moveDown = <button id="move-down" onClick={this.handleMoveDown}>Dół</button>;
             moveUp = <button id="move-up" onClick={this.handleMoveUp}>Góra</button>;
         }
         return <div className = "task-wrapper">
             ...
             {moveDown}
             {moveUp}
             {/*<button id="move-down" onClick={this.handleMoveDown}>Dół</button>*/}
             {/*<button id="move-up" onClick={this.handleMoveUp}>Góra</button>*/}
